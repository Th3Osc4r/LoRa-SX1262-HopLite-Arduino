...
Hoplite uses a different strategy: redundant transmission for critical events (3 copies per alarm, spaced in time) and acceptance of per-packet loss for routine telemetry.  This approach was validated across 513 alarm events with 99.8% event delivery — without the loss of a single acknowledgment packet.
